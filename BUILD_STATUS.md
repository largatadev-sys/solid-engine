...
| S4.22 | Home feed: public postcards *(grilled 2026-08-12 — ADR-025: per-entry opt-in sharing, dump-implies-consent, independent of trip publish; Home becomes the landing route; engagement chrome stubbed the S4.21 way; design baseline = the Claude Design home-feed project, link in the spec; six founder rulings through 2026-08-13 moved the pin onto the activity's place, stripped the lifecycle tint, and pointed the Trip Post badge at a public trip diary this story grew to serve it)* | ✅ | [spec](docs/plans/S4.22-home-feed/spec.md) |
