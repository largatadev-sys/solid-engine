...
| S4.14 | Traveler vanity number + founder short handles *(grilled and parked 2026-08-08, pulled early the same day by founder call — cohort badge + per-month pool allocation; hand-planted founder `0` and 2-char handles; candidate capability: short handle → reg. #14)* | 🔄 | [spec](docs/plans/S4.14-vanity-number/spec.md) |
