...
| S4.22 | Home feed: public postcards *(grilled 2026-08-12 — ADR-025: per-entry opt-in sharing, dump-implies-consent, independent of trip publish; Home becomes the landing route; engagement chrome stubbed the S4.21 way; design baseline = the Claude Design home-feed project, link in the spec)* | ⬜ | [spec](docs/plans/S4.22-home-feed/spec.md) |
