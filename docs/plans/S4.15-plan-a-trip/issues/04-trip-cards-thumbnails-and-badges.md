...
- [ ] Cards render thumbnail · date-over-title · status slot per the mock; the destinations line is gone (spec AC 6).
...
- [ ] Coverless trips render the placeholder tile.
- [ ] Published trips show the badge with public/private distinguished; unpublished trips show none — pinned by unit tests across the three publication shapes.
- [ ] Card taps keep their current per-state destinations.
