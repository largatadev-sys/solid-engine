...
- **State-honest copy** (decision 2): title **"Trip Created!"**; body — the trip's title in regular double quotes — **“⟨trip title⟩” is saved to your trips. Open the workspace to start building the days.** The mock's "available for travelers to discover and fork" must not appear anywhere.
