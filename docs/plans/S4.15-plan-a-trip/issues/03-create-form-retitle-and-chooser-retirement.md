...
- Retire the chooser: delete `itineraries/create.tsx` (Start from Scratch / Fork) and repoint or delete the `(trips)/create.tsx` shim so `/create` lands on the form; no route in the tree renders the chooser.
