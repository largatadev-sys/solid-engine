...
- [x] **Amended on the rung, 2026-09-05:** the sheet ships **without** frame 5b's identity header and **without** its Dismiss row — the sheet titles itself with the handle, and a scrim tap already dismisses, so both said something twice. Founder's call while walking it; argued in the spec's Comments. The rest of this criterion stands as written.
