...
- [ ] **The ≥1 gate replaces >3 everywhere:** the results screen's People group *and* the suggestions overlay's "See all people" render from the first match (`morePeople` stops gating the door; the cap-3 display rule stays).
