...
|---|---|---|
| **Traveler** | id, email, display name, auth identity | The account. Deletion = **anonymization**: PII erased; ledger entries and ownership-transfer records survive anonymized (reconciles with INV-4/8). |
