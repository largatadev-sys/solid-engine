...
- **Status.** Accepted · 2026-07-24 (S1.4 grilling, founder-ruled) · partially supersedes ADR-001's queued-writes clause for plan content; waives ADR-008 for the S1.3 write endpoints (recorded below)
