package com.largata.postcard.entity;

import com.largata.common.geo.InvalidPinException;
import com.largata.common.geo.Pin;
import com.largata.common.id.UuidV7;
import com.largata.postcard.exception.PostcardCaptionTooLongException;
...
public class Postcard {
    ...
    public static Postcard standalone(
    ...
    public static Postcard postedFromActivity(
            UUID authorId,
            UUID diaryId,
            UUID diaryDayId,
            UUID tripId,
    ...
    public void fileOn(UUID newDiaryId, UUID newDiaryDayId, Instant at) {
    ...
    public void recaption(String newCaption, Instant at) {
        this.caption = normalizeCaption(newCaption);
        this.updatedAt = at;
    }


    public void moveTo(String newPlace, Pin newPin, Instant at) {
