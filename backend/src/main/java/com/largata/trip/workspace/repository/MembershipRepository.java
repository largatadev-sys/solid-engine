...
import com.largata.trip.workspace.entity.Membership;
import com.largata.trip.workspace.entity.MembershipId;
import com.largata.trip.workspace.entity.WorkspaceState;
import com.largata.trip.workspace.service.MemberCountRow;
...
public interface MembershipRepository extends JpaRepository<Membership, MembershipId> {
    ...
    @Query("SELECT new com.largata.trip.workspace.service.MemberCountRow(m.workspace.itineraryId, COUNT(m)) "
