...
public class EditLease {
    ...
    public static EditLease heldBy(
    ...
    public void takeOver(UUID newHolderId, Instant acquiredAt, Instant expiresAt) {
    ...
    public void renewUntil(Instant newExpiresAt) {
    ...
    public boolean isHeldBy(UUID travelerId) {
