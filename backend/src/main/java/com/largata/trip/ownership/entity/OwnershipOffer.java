package com.largata.trip.ownership.entity;
...
public class OwnershipOffer {
    ...
    public static OwnershipOffer open(UUID workspaceId, UUID targetTravelerId, UUID offeredBy, Instant now) {
