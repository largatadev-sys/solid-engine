-- V44 — the itinerary object (CM-1 ticket 02, ADR-034).
--
...
--
-- audience is TEXT holding the enum NAME ('PUBLIC'/'PRIVATE') — @Enumerated(STRING) writes the
-- name, the V3 'draft' trap. The stepping IT pins the spelling.
