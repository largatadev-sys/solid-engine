...
const t = (owner, title, destination, currency, bestTimeOfYear, days) => ({
  owner,
  title,
  destination,
  currency,
...
const SPECS = [
  ...
  t('t1', 'Coron, wrecks and lakes', 'Coron', 'PHP', 'Nov – May', [
  ...
  t('t1', 'The Ha Giang loop', 'Ha Giang', 'VND', 'Sep – Nov', [
  ...
  t('t1', 'Java, volcano to volcano', 'Java', 'IDR', 'May – Sep', [
  ...
  t('t1', 'Northern Laos overland', 'Luang Prabang', 'LAK', 'Nov – Mar', [
  ...
  t('t1', 'Myanmar, Bagan to Inle', 'Bagan', 'MMK', 'Nov – Feb', [
  ...
  t('t2', 'Hakone and back', 'Hakone', 'JPY', 'Oct – Nov', [
  ...
  t('t2', 'Seoul and Jeju', 'Seoul', 'KRW', 'Apr – Jun', [
  ...
  t('t2', 'Taiwan, a loop by train', 'Taipei', 'TWD', 'Oct – Dec', [
  ...
  t('t2', 'Hokkaido end to end', 'Hokkaido', 'JPY', 'Jun – Sep', [
  ...
  t('t2', 'Uzbekistan, the Silk Road cities', 'Samarkand', 'UZS', 'Apr – May', [
  ...
  t('t2', 'Honshu slowly, south to north', 'Tokyo', 'JPY', 'Mar – May', [
  ...
  t('t3', 'Adelaide to the Flinders', 'Flinders Ranges', 'AUD', 'Apr – Oct', [
  ...
  t('t3', 'The North Island, top to bottom', 'North Island', 'NZD', 'Nov – Apr', [
  ...
  t('t3', 'Tasmania, the whole island', 'Tasmania', 'AUD', 'Dec – Mar', [
  ...
  t('t3', 'The South Island, unhurried', 'South Island', 'NZD', 'Nov – Apr', [
  ...
  t('t4', 'The Baltic capitals', 'Tallinn', 'EUR', 'Jun – Aug', [
  ...
  t('t4', 'Andalusia by train', 'Seville', 'EUR', 'Mar – May', [
  ...
  t('t4', 'Scotland by the west coast', 'Scottish Highlands', 'GBP', 'May – Sep', [
  ...
  t('t4', 'Portugal end to end, again', 'Lisbon', 'EUR', 'Apr – Jun', [
  ...
  t('t4', 'Central Europe by rail', 'Prague', 'EUR', 'May – Sep', [
  ...
  t('t5', 'The Cyclades, five islands', 'Cyclades', 'EUR', 'May – Sep', [
  ...
  t('t5', 'Turkey, Aegean to Cappadocia', 'Cappadocia', 'TRY', 'Apr – Jun', [
  ...
  t('t5', 'Sicily, the full circle', 'Sicily', 'EUR', 'Apr – Jun', [
  ...
  t('t6', 'Cusco and the Sacred Valley', 'Cusco', 'PEN', 'May – Sep', [
  ...
  t('t6', 'Bolivia, altiplano and salt', 'La Paz', 'BOB', 'May – Oct', [
  ...
  t('t6', 'Brazil, Rio to Salvador', 'Rio de Janeiro', 'BRL', 'Apr – Oct', [
  ...
  t('t6', 'Patagonia, the full traverse', 'Patagonia', 'ARS', 'Nov – Mar', [
  ...
  t('t7', 'The California coast', 'Big Sur', 'USD', 'Apr – Oct', [
  ...
  t('t7', 'The Yucatán, ruins and cenotes', 'Yucatán', 'MXN', 'Nov – Apr', [
  ...
  t('t7', 'Iceland, the south coast', 'Iceland', 'ISK', 'Jun – Aug', [
  ...
  t('t7', 'Utah and the desert parks', 'Utah', 'USD', 'Apr – Oct', [
  ...
  t('t7', 'The Canadian Rockies', 'Banff', 'CAD', 'Jun – Sep', [
  ...
  t('t7', 'The Pacific Northwest, end to end', 'Pacific Northwest', 'USD', 'Jul – Sep', [
  ...
  t('t8', 'Namibia, dunes to Etosha', 'Namibia', 'NAD', 'May – Oct', [
  ...
  t('t8', 'Ethiopia, the northern circuit', 'Lalibela', 'ETB', 'Oct – Mar', [
  ...
  t('t8', 'East Africa, plains to islands', 'Serengeti', 'TZS', 'Jun – Oct', [
  ...
  t('t9', 'Sri Lanka, hill country by rail', 'Sri Lanka', 'LKR', 'Jan – Mar', [
  ...
  t('t9', 'Bhutan, west to centre', 'Bhutan', 'BTN', 'Mar – May', [
  ...
  t('t9', 'Ladakh and Kashmir', 'Ladakh', 'INR', 'Jun – Sep', [
  ...
  t('t9', 'Everest Base Camp, the long way', 'Khumbu', 'NPR', 'Mar – May', [
  ...
  t('t10', 'Lapland in deep winter', 'Finnish Lapland', 'EUR', 'Dec – Mar', [
  ...
  t('t10', 'Iceland, north and west', 'Iceland', 'ISK', 'Jun – Aug', [
  ...
  t('t10', 'The Norwegian fjords', 'Norway', 'NOK', 'May – Sep', [
  ...
  t('t10', 'Arctic Norway and Svalbard', 'Svalbard', 'NOK', 'Mar – Sep', [
  ...
  t('t10', 'The Faroes and Iceland', 'Faroe Islands', 'DKK', 'Jun – Aug', [
