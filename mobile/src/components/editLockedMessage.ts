...
export const publishedPlanNotice: EditLockedMessage = {
  ...
  body: 'A published plan is fixed so nobody reads a trip that changes under them. Unpublish it to edit — the page comes down, the trip keeps its state, and you can publish again after.',
};
