...
export const IDENTITY_MAP = {
  ...
  'web/postcard-delete': { tags: ['t3'], sharesWith: 'shared' },
  'web/unpublish': { tags: ['t4'], sharesWith: 'shared' },
  'web/trips-swipe': { tags: ['t1', 't2'], sharesWith: 'shared' },
  ...
  'web/private-profile': { tags: ['t1', 't3'], sharesWith: 'shared' },
